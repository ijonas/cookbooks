...
maintainer_email "ijonas@pixelballistics.com"
license          "Apache 2.0"
...
recipe "wordpress", "Installs and configures wordpress LAMP stack on a single system, using nginx as the webserver."
