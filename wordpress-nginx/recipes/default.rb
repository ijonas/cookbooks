...
# Recipe:: default
#
# Copyright 2009-2010, Pixel Ballistics
#
...
remote_file "/tmp/wordpress-#{node[:wordpress][:version]}.tar.gz" do
...
execute "untar-wordpress" do
  ...
  command "tar --strip-components 1 -xzf /tmp/wordpress-#{node[:wordpress][:version]}.tar.gz"
